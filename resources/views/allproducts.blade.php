				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<div class="col-sm-4">
							...
							@endforeach
						@else
						No hay productos con estas características.
						@endif
					</div><!--features_items-->
					...
					<div class="recommended_items"><!--recommended_items-->
						...
						<div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
							<div class="carousel-inner">
								<div class="item active">
								@foreach ($recommended_products as $recproduct)
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="{{Storage::disk('local')->url('images/'.$recproduct->image)}}" alt="" width="200" height="200" style="max-height:200px"  />
													<h2>{{ $recproduct->price }}€</h2>
													<p>{{ $recproduct->name }}</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
												<div class="product-overlay">
													<div class="overlay-content">
														<h2>{{ $recproduct->price }}€</h2>
														<p>{{ $recproduct->name }}</p>
														<a href="{{route('AddToCartProduct',['id'=>$recproduct->id])}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
													</div>
												</div>
											</div>
										</div>
